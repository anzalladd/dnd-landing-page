...
const textLeftRef = ref<HTMLElement | null>(null)
const textRightRef = ref<HTMLElement | null>(null)
...
onMounted(() => {
  ...
  gsap.fromTo(
    ...
    { opacity: 0, y: 50 },
    {
      ...
      delay: 0.15,
      scrollTrigger: {
        trigger: rightCardRef.value,
        start: 'top 85%',
      },
    }
  )

  // Animations for the text below
  gsap.fromTo(
    textLeftRef.value,
    { opacity: 0, y: 30 },
    {
...
<template>
  <section
    ref="sectionRef"
    class="w-full bg-white px-4 md:px-8 lg:px-[60px] py-[80px] md:py-[120px]"
  >
    <div class="max-w-[1320px] mx-auto flex flex-col gap-12 md:gap-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-16 gap-x-6 md:gap-x-8 lg:gap-x-16 items-start">
        ...
        <div ref="textLeftRef" class="flex flex-col gap-6 w-full max-w-[580px] order-1 md:order-3">
          ...
          <p class="font-sans text-[16px] leading-[26px] md:text-[18px] md:leading-[28px] text-[#121212]/80">
            At D&amp;D, strategy comes first. We design digital products and experiences that solve real business problems, grow with the market, and never lose sight of what makes your brand unique.
          </p>
        </div>
        ...
        <div ref="textRightRef" class="flex flex-col gap-10 w-full max-w-[580px] order-4 md:order-4">
          ...
          <div class="flex flex-col gap-3">
            ...
            <p class="font-sans text-[15px] leading-[24px] md:text-[16px] md:leading-[26px] text-[#121212]/80">
              From idea to launch, and beyond, our product design team works to efficiently and rapidly define, design and prototype world-class digital products, services or platforms.
            </p>
          </div>
          ...
          <div class="flex flex-col gap-3">
            ...
            <p class="font-sans text-[15px] leading-[24px] md:text-[16px] md:leading-[26px] text-[#121212]/80">
              From training AI-models and implementing scalable architectures in the cloud, to delivering high-performing website and platforms, we make digital products run.
            </p>
          </div>
